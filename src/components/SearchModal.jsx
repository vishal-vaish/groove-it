...
import {useAddTrackToMyPlaylist} from "../lib/actions/playlist.action.js";
import {useState} from "react";
import {useFetchSearch} from "../lib/actions/editorial.action.js";
import useDebounce from "../hooks/useDebounce.jsx";
import {classNames, formatDuration, formatIndexToDouble, truncate} from "../lib/utils.js";
        ...
        <div className="relative w-full p-2 rounded shadow-sm bg-sidebar h-14">
          <div className="flex items-center w-full h-full gap-2 px-2 border-0 rounded border-divider">
            ...
            <input
              ...
              placeholder="Search for songs or tarcks ..."
              value={searchTerm || ""}
