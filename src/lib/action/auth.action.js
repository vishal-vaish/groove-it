...
import {
  ...
  createUserWithEmailAndPassword, getRedirectResult,
...
import {
  auth, githubProvider, googleProvider
} from "../../config/firebase.config.js";
import {useEffect} from "react";
import useNotification from "../../hooks/useNotification.jsx";
import {fbSetDoc} from "../helpers.js";
...
export const useForgetPassCreate = () => {
  ...
  return {forgetPassCreate, isSubmitted, isSubmitting};
};
